...
def loginPage(logdata):
    ...
    heading = Label(login_frame,text="Examination Login",fg="black",bg="white")
    heading.config(font=('calibri 40'))
    heading.place(relx=0.2,rely=0.1)

    #ID
    ulabel = Label(login_frame,text="ID",fg='black',bg='white')
...
def signUpPage():
    ...
    heading = Label(sup_frame,text="Examination System ",fg="black",bg="white")
    heading.config(font=('calibri 40'))
    heading.place(relx=0.2,rely=0.1)
    ...
    #ID
    ulabel = Label(sup_frame,text="ID",fg='black',bg='white')
    ...
    #country
    clabel = Label(sup_frame,text="State",fg='black',bg='white')
...
def menu():
    ...
    wel = Label(menu_canvas,text=' W E L C O M E  T O  E X A M I N A T I O N  S Y S T E M ',fg="white",bg="#101357")
    wel.config(font=('Broadway 12'))
    wel.place(relx=0.1,rely=0.02)
    
    
    level = Label(menu_frame,text='SELECT YOUR EXAM SUBJECT !!',bg="white",font="calibri 18")
    level.place(relx=0.25,rely=0.3)
    
    
    var = IntVar()
    easyR = Radiobutton(menu_frame,text='PYTHON',bg="white",font="calibri 16",value=1,variable = var)
    easyR.place(relx=0.25,rely=0.4)
    
    mediumR = Radiobutton(menu_frame,text='AUTOMATA THEORY',bg="white",font="calibri 16",value=2,variable = var)
    mediumR.place(relx=0.25,rely=0.5)
    
    hardR = Radiobutton(menu_frame,text='COMPUTER NETWORKS',bg="white",font="calibri 16",value=3,variable = var)
    hardR.place(relx=0.25,rely=0.6)

    hardR1 = Radiobutton(menu_frame,text='ENGINEERING MATHS',bg="white",font="calibri 16",value=3,variable = var)
    hardR.place(relx=0.25,rely=0.6)

    hardR2 = Radiobutton(menu_frame,text='JAVA',bg="white",font="calibri 16",value=3,variable = var)
    hardR.place(relx=0.25,rely=0.6)
    ...
    def navigate():
        ...
        if x == 1:
            ...
            pass
    submit = Button(menu_frame,text="SUBMIT",bg="white",font="calibri 12",command=navigate)
    submit.place(relx=0.25,rely=0.8)
    menu.mainloop()
def easy():
...
def difficult():
    ...
    previous = Button(hard_frame,command=display,text="Previous")
    previous.place(relx=0.5,rely=0.82,anchor=CENTER)
...
def showMark(mark):
    ...
    st = "Your Exam score is "+str(mark)+"/5"
...
def start():
    global root 
    root = Tk()
    canvas = Canvas(root,width = 520,height = 340)
    canvas.grid(column = 0 , row = 1)
    img = PhotoImage(file="back.png")
    canvas.create_image(50,10,image=img,anchor=NW)

    button = Button(root, text='START YOUR EXAM',command = signUpPage) 
